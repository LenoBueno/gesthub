  ...
  return (
    <div className="flex flex-col sm:flex-row flex-wrap gap-2.5 w-full items-start sm:items-center">
      ...
      <button
        ...
        className="w-full sm:w-auto flex items-center justify-center gap-2 px-3 py-1 text-xs md:text-sm md:px-4 md:py-2 border border-eink-lightGray rounded-lg hover:bg-eink-lightGray/10"
      >
